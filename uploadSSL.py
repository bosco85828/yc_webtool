...
def find_domain(data):
    ...
    # for cert in certs:
    #     name=cert.find('name').get_text()
        
    cert=[ x for x in certs if x.find('name').get_text()=="bill.test" ]
    print(cert)
    # return cert_name
...
-----END PRIVATE KEY-----"""
    ...
    # row_name_list=find_domain(data)
    # # print(row_name_list)
    # name_list=[ str(x)[6:-7] for x in row_name_list]
